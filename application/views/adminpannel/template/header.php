				...
				<ul class="navbar-nav navbar-right">
						...
						<div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
							...
							<div class="dropdown-list-content dropdown-list-message">
								<a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="<?php echo base_url();?>assets/admin/assets/img/users/user-1.png"
										...
										<img alt="image"
											src="<?php echo base_url();?>assets/admin/assets/img/users/user-2.png"
											class="rounded-circle">
										...
										<img alt="image"
											src="<?php echo base_url();?>assets/admin/assets/img/users/user-5.png"
											class="rounded-circle">
										...
										<img alt="image"
											src="<?php echo base_url();?>assets/admin/assets/img/users/user-4.png"
											class="rounded-circle">
										...
										<img alt="image"
											src="<?php echo base_url();?>assets/admin/assets/img/users/user-3.png"
											class="rounded-circle">
							...
							<div class="dropdown-list-content dropdown-list-icons">
								<a href="#" class="dropdown-item dropdown-item-unread"> <span
										...
										class="dropdown-item-icon bg-info text-white"> <i class="fas
												fa-bell"></i>
									</span> <span class="dropdown-item-desc"> Welcome to Sakhi<span
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"
							class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
								src="<?php echo base_url();?>assets/admin/assets/img/user.png"
								class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
						<div class="dropdown-menu dropdown-menu-right pullDown">
							<div class="dropdown-title">Hello Team Sakhi</div>
							...
							<a href="<?php echo base_url();?>auth/logout" class="dropdown-item has-icon text-danger"> <i
				...
				<aside id="sidebar-wrapper">
					<div class="sidebar-brand">
						...
						<a href="index.html"> <img alt="image"
								src="<?php echo base_url();?>uploads/<?php echo $profile->logo?>" class="header-logo" />
							<!-- <span class="logo-name">Sakhi</span> -->
						</a>
					</div>
					<ul class="sidebar-menu">
						...
						<li class="dropdown">
							<a href="<?php echo base_url();?>admin/profile" class="nav-link"><i
						...
						<li class="dropdown">
							<a href="#" class="menu-toggle nav-link has-dropdown"><i
									data-feather="command"></i><span>Team</span></a>
							<ul class="dropdown-menu">
								<li><a class="nav-link" href="<?php echo base_url();?>admin/team">Add Team</a></li>
								<li><a class="nav-link" href="<?php echo base_url();?>admin/edit_team">Edit Team</a>
								</li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="#" class="menu-toggle nav-link has-dropdown"><i
									data-feather="mail"></i><span>Services</span></a>
							<ul class="dropdown-menu">
								<li><a class="nav-link" href="<?php echo base_url();?>admin/add_service">Add Service</a>
								</li>
								<li><a class="nav-link" href="<?php echo base_url();?>admin/edit_service">Edit
										Service</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="#" class="menu-toggle nav-link has-dropdown"><i
									data-feather="file"></i><span>FAQ's</span></a>
							<ul class="dropdown-menu">
								<li><a class="nav-link" href="<?php echo base_url();?>admin/add_faq">Add FAQ's</a></li>
								<li><a class="nav-link" href="<?php echo base_url();?>admin/edit_faq">Edit FAQ's</a>
								</li>
							</ul>
						</li>
						...
						<li class="dropdown active">
							<a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span>Basic
									Components</span></a>
							<ul class="dropdown-menu">
								<li class="active"><a class="nav-link" href="alert.html">Alert</a></li>
