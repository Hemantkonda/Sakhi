		...
		<div class="section-body">
			<div class="row mt-sm-4">
				<div class="col-lg-12 col-md-12">
					<form method="post" action="<?php echo base_url();?>admin/teamadded" enctype="multipart/form-data"
						...
						<div class="card-body">
							<div class="row">
								<input type="text" name="proid" id="proid"
									value='<?= isset($team->id) ? $team->id : '' ;?>' hidden>
								<div class="form-group col-md-6 col-12">
									<label>Add Team Member Image</label>
								...
								<div class="form-group col-md-6 col-12">
									...
									<div class="invalid-feedback">
										Please fill in the Member Name
									</div>
								</div>
								<div class="form-group col-md-6 col-12">
									<label>Designation</label>
									<input type="text" class="form-control" name="role" required
										value="<?= isset($team->role) ? $team->role : '' ;?>">
									<div class="invalid-feedback">
										Please fill in the Member Designation
									</div>
								</div>
								<div class="form-group col-md-6 col-12">
									<label>Background</label>
									<input type="text" class="form-control" name="background" required
										value="<?= isset($team->background)?$team->background : '' ;?>">
									<div class="invalid-feedback">
										Please fill in the Member Background
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-4 col-12">
									...
									<input type="text" class="form-control" name="insta" placeholder="Instagram Link"
										value="<?= isset($team->insta)?$team->insta : '' ;?>">
								</div>
								<div class="form-group col-md-4 col-12">
								...
								<div class="form-group col-md-4 col-12">
									...
									<input type="text" class="form-control" name="linkedin" placeholder="LinkedIn Link"
										value="<?= isset($team->twitter)?$team->linkedin:'';?>">
								</div>
							</div>
						</div>
