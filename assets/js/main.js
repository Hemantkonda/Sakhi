...
// Service Model buttons
$(document).ready(function () {
	$('#booking_service').on('click', function () {
		$('#packs').addClass('d-block');
	})

	$('.addshift').on('click', function () {
		$('.shift2').addClass('d-block');
		$(this).addClass('d-none');
	})

	$('.removeshift').on('click', function () {
		$('.shift2').removeClass('d-block');
		$('.addshift').removeClass('d-none');
	})

	$('.option_select').on('click', function () {
		$(this).parent().siblings().children().removeClass('activeselect');
	...
	$('.next_page').on('click', function () {
		...
		var opt = $('.activeselect');
		if (opt) {
			$('.form1').addClass('d-none');
			$('.form2').removeClass('d-none');
			$('.previous_page').addClass('d-block');
			$('.next_page').addClass('d-none');
		} else {
	...
	$('.previous_page').on('click', function () {
		...
		$('.previous_page').removeClass('d-block');
